...
func compileToObj(params compileParams, irPath string) (string, error) {
...
func compileToBc(_ int, irPath string) (string, error) {
	bcPath := strings.TrimSuffix(irPath, ".ll") + ".bc"

	cmd := exec.Command("llvm-as", "-o", bcPath, irPath)
